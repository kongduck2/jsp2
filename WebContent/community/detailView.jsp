		...
		<ul id="main">
			...
			<li>
				...
				style="font-size: 70%; padding-left: 30px;">(${bean.ip})</span></li>
					<li>작성날짜</li>
					<li><fmt:formatDate value="${bean.wdate }" pattern="yyyy-MM-dd hh:mm" /></li>
					<!-- pattern="yyyy-MM-dd hh:mm" 날짜 형식 정의가능 
						type = date,time,both -->
				</ul>
			</li>
			<li id="content">
		...
		<ul id="main">
			...
			<li>
				<ul class="row-2">
					...
					<li>
						<input type="submit" value="저장" class="smallB">
						<input type="reset" value="취소" class="smallB">
					</li>
				</ul>
			</li>
         ...
         <div style="padding: 0px 20px;">
            ...
            <form action="deleteAction.jsp" method="post" name="frmPassword"
              ...
              <input
               ...
               <span style="color:red;font-size:27px; " id="err"></span>
            </form>
         </div>
      </div>
   </div>
